...
#     READ DATA FILES     #
# ASSUMPTION: The ".txt" data file is present in the working directory
...
par (mfrow=c(2,2))
with (hPowConsumeSubset, plot (DateTime, Global_active_power, ylab="Global Active Power", xlab="", col="black", type="l"))

with (hPowConsumeSubset, plot (DateTime, Voltage, col="black", xlab="datetime", type="l"))
...
legend("topright", bty="n", cex=0.9, lty=c(1,1), col = c("black", "red", "blue"),
       legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

with (hPowConsumeSubset, plot (DateTime, Global_reactive_power, xlab="datetime", col="black", type="l"))
par (mfrow=c(1,1))
